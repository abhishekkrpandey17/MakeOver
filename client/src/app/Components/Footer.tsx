...
const Footer = () => {
  ...
  return (
    <div className="bg-[#dbc3eb]  pt-10 overflow-x-hidden">
      <motion.footer
        ref={ref}
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-12">
          ...
          >
            <div className="flex items-center w-full md:w-[70%] px-4 py-3 bg-[#dbc3eb]">
            ...
            <button
              type="submit"
              className="w-[40%] md:w-[40%] py-3 bg-darkviolet text-white font-medium text-lg md:rounded-none md:rounded-r-full rounded-r-full transition-all hover:bg-[#5ba964] transform  duration-200 hover:scale-105"
            >
              Subscribe
            </button>
          </motion.form>
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12 w-full justify-between">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-sm md:text-base font-medium">
              {["Pricing", "About us", "Features", "Help Center", "FAQs"].map(
                (text, i) => (
                  <Link
                    key={i}
                    href="#"
        ...
        >
          <p>
            © 2024 MakeOver • <Link href="#">Privacy</Link> •{" "}
