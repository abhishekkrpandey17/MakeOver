      ...
      <div className="relative mainHero block lg:hidden ">
        <div className="bg-lavender h-[70vh] flex">
          <div className="left w-[70%]">
            ...
            <p className="ml-13 w-[32%] pr-[4px] absolute top-[40%]  z-[100]  left-[-10%] text-[3.75vmin]  leading-[7vmin] md:top-[45%] md:text-[2.15vmin] md:leading-[4vmin] md:left-[-4%] text-start">
