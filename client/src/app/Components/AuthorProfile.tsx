      ...
      <div className="flex justify-center">
        <div className="w-full max-w-4xl bg-[#eddcf8] rounded-3xl shadow-xl p-6  md:p-10 text-center">
          ...
          >
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-[#171619]">
              Emily Johnson
            </h2>
            <p className="text-sm md:text-base text-[#6c6374] mt-1">
              10 years experience •{" "}
              <span className="font-medium">MakeupTechnique & Skincare</span>
            </p>
            <p className="text-sm md:text-base text-[#6c6374] mt-3">
              Professional makeup artist with a decade of experience in creating
              personalized beauty routines and sharing expert tips on skincare
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
              {blogs.map((blog, index) => (
                ...
                >
                  ...
                  <h4 className="text-[#171619] font-semibold text-sm mb-1">
                    {blog.title}
                  </h4>
